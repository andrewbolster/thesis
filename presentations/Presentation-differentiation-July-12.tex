...
\title[Differentiation Report]{An Investigation into Trust and Reputation Frameworks for Autonomous Underwater Vehicles}

\subtitle
{Differentation Report}
...
\begin{frame}{Make Informative. Use Uppercase Letters.}{Subtitles are optional.}
