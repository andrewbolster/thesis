...
Formally, this saturation rate occures if
...
\begin{figure}[h]
	...
	\caption{\gls{mtfm} Trust assessments of $n_1$ ($T_{1,X}$), showing Direct, Recommender and Indirect relationships, and derived aggregates} 
...
\end{figure}
\todo{FIX:Malicious Factors graph is out of date and shouldn't have physical metrics after rearrange. Also needs vector}
