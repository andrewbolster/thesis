...
\begin{poster}%
  ...
  % Color style
  bgColorOne=white,
  borderColor=QUBBROWN,
  headerColorOne=QUBRED,
  headerColorTwo=QUBRED,
...
%  background=shade-tb,
  ...
  % Eye Catcher
  {\includegraphics[height=7em]{../../figures/logo_ECIT_sm}} 
  % Title
  {\bf\textsc{Distributed Behaviour-Based Trust for Autonomous Sub-marine Fleets}\vspace{0.5em}}
  % Authors
  {\textsc{\{ Andrew.Bolster and Alan.Marshall \}@liverpool.ac.uk}}
  % University logo
  {% The makebox allows the title to flow into the logo, this is a hack because of the L shaped logo.
    \includegraphics[height=9.0em]{../../frontmatter/figures/crest}
  }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  Establishing auditable communications trust in the harsh marine acoustic environment
  that is distributed and .
 }
