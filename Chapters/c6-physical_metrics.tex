...
\def\ChapterTitle{Modelling and Analysis of Collaborative Node Kinematic Behaviuors in Underwater Acoustic MANETs}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{throughput_performance_static.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{prod_breakdown_static.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{delay_range.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{rts_range.pdf}
