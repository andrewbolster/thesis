...
Four mobility scenarios are initially investigated, as per \cite{Guo11}:
\begin{enumerate}
...
Random Forest accomplishes this by generating a large number of random regression trees and prunes these trees to fit incoming data.\todo{More background on regression, Random Forest, and why ML is used in this context}
