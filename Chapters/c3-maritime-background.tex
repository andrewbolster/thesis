...
As autonomous underwater vehicles (AUVs) become more capable, and economical, they are being used in many applications requiring trust.
...
Faced with the growing adoption of similar but disparate UAV systems within NATO territories and coalition nations, STANAG 4586\cite{STANAG4586} was promulgated in 2005 and defined a logistic and interoperability framework to provide commonality in the command and comtrol architecture and implementations of UAV/Ground station communications.
...
4586 described five Levels of Interoperability (LOI) for compliant UAV systems, shown in Table~\ref{tab:levels_of_interoperability}.
...
This includes now legacy M160 mine clearance platform and the highly popular (both with forces and their in-field operators) iRobot Packbot inspection and explosive ordance disposal (EOD) family of robotic platforms.
