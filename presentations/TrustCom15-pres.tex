...
\begin{frame}{Trust in Conventional MANETS}
  \begin{itemize}
    ...
    \item
      Centralised methods (CA/TTP/PKI) unsuitable for dynamic networks in terms of efficiency and robustness\autocite{Caiti2011}.
    \item 
...
\begin{frame}[allowframebreaks]{Single-Metric TMFs}
  ...
  \todo{Possibly cut the breakdown}
  \framebreak
  \begin{itemize}
  \item
...
\begin{frame}{Multi-Metric TMF - Topological Relationships} 
  ...
  $T_{i,j}^{MTFM}$
    ...
    \todo{Try and ``Stepwise'' this\dots}
