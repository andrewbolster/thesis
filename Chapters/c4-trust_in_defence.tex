...
\todo{Ch4 Needs a near complete rewrite; \\
	Intro\\
	Describe the simulation environment\\
	Compare single and vector TMF operation in the environment (separately)
	Optimise vector TMF with metric weighting strategy}
