...
Grey Theory counters this by performing cohort based normalisation of \todo{could be worded differently}arbitraty-dimensional metrics at runtime. 
...
\begin{enumerate}
  \item 
\end{enumerate}
\todo{All the 'programming' for this bit is done, it's just writing. Remember to highlight the relationships between delay/distance/trust and rssi/plr/trust}
