...
\title{Cross Domain Trust Assessment Framework for Autonomous Underwater MANETs}
...
\IEEEspecialpapernotice{Pages: 12, Deadline 28/4}
...
% no \IEEEPARstart
This paper proposed a new approach to determine trust in resource-constrained networks of autonomous systems, using a combination of physical and communications assessments within a team to detect and identify malicious or failing operation within their cohort.
Building on previous work\cite{Bolster2016a} where the usefulness of these multi-domain assessments was demonstrated, we present a metholodology to generate best-attempt subsets of ``useful'' metrics for Trust assessment, reducing detection complexity and improving accuracy.
...
Initial explorations of this opportunity have been positive \cite{Bolster2015,Bolster2016,Bolster2016a}, but limited investigation to the either separate, or ensemble collection of trust metrics from the physical and commuications domains.
