...
In this chapter a methodology is demonstrated that applies Grey Sequence operations and Grey Generators to provide trust assessment in a sparse, asynchronous metric space across multiple domains of trust.
...
\todo{NORELEASE: IF CLASSIFICATION GOES SOUTH YOU NEED TO FIX THE INTRO}
