...
\todo{short discussion of autonomy}
...
\todo{Expand and elaborate on physical trust results}
...
Further, a methodology for assessing the usefulness of individual metrics in this cross-domain space is demonstrates, allowing for the elimination of redundant metrics, simplifying the runtime assessment process\cite{Bolster2016a}\todo{Discussion on Multi Domain results}

\subsubsection{\autoref{ch:conclusion}}

\todo{Describe Conclusion (Is this redundant?)}
