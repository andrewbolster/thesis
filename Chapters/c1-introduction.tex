...
The distributed and dynamic nature of \glspl{manet} mean that it is difficult to maintain a trusted \gls{ttp} or evidence based trust system such as Certificate Authorities or using \gls{pki}.\todo{more background on the operation of TTP/CA/PKI}
