...
The use and applications of Autonomous Underwater Vehicles (AUVs) has undergone a great expansion in recent times; current applications and considerations are given in Table~\ref{tab:auv_apps} (summarised from \cite{Jalving2003}\cite{andThen}\cite{AndTHEN}).
...
Such systems can be accurate to less that $0.1m$ or better in ideal deployments and are regularly used in controlled autonomous survey environments such as harbour patrol operations. 
...
Several sensor synthesis processes have been demonstrated which combine information from INS along with DVL data to improve localisation into the sub-decimeter level\cite{Jalving2003}.
...
\begin{figure*}
  \centering
  \subfloat[INDD]{\includegraphics[width=0.3\linewidth]{summedsigmabar_INDD}}
  \subfloat[INHD]{\includegraphics[width=0.3\linewidth]{summedsigmabar_INDD}}
  \subfloat[Speed]{\includegraphics[width=0.3\linewidth]{summedsigmabar_Speed}}
