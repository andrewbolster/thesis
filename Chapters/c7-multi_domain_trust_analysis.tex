...
\todo{Could do with a conceptual graphic showing what these look like, although it'd be messy as all hell}

\todo{Could also do with a investigation into the deviation of T's; so far most of this analysis averages everything, which is almost certainly not the best approach alone}
